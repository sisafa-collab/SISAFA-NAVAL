...
# --- FINALIZA A ABA 1 (FECHAMENTO DO TRY/EXCEPT DA ABA ANTERIOR) ---
                ...
                # =================================================================
                # 2. ABA: PRODUTIVIDADE (PM4PY + FILTRO DE MÊS + NOMES)
                # =================================================================
                with tab_prod:
                    ...
                    try:
                        ...
                        if df_hist.empty:
                            ...
                            if df_hist.empty:
                                ...
                                # --- MAPEAMENTO DE NOMES (ETAPAS) ---
                                mapa_nomes = {
                                    1: "1. FATURA CADASTRADA", 2: "2. EM AUDITAGEM",
                                    3: "3. AUDITADA", 4: "4. AGUARDANDO NE",
                                    5: "5. FATURA EMPENHADA", 6: "6. AGUARDANDO NF",
                                    7: "7. EM LIQUIDAÇÃO", 8: "8. FATURA LIQUIDADA",
                                    9: "9. FATURA PAGA"
                                }

                                # Prepara DataFrame para o PM4Py
                                ...
                                try:
                                    ...
                                    st.warning("Visualização do mapa temporariamente indisponível.")
