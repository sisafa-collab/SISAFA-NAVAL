        ...
        with tab_prod:
            ...
            try:
                ...
                if df_hist.empty:
                    ...
                    # Vacina das datas e remoção de Fuso Horário
                    ...
                    df_pm = df_hist.rename(columns={'nup': 'case:concept:name', 'status_destino': 'concept:name', 'timestamp': 'time:timestamp'})
                    ...
                    try:
                        ...
                        st.info("ℹ️ Mapa visual indisponível no servidor.")
